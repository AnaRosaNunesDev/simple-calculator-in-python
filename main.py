...
cor3 = "#141847" # Azul carregado
cor4 = "#CAC4C8" # cinza
cor5 = "#B965B5" # Pink/ Rosa
cor6 = "#FCFCFC00" # transparente
...
frame_corpo = Frame(janela, width=235, height=288, bg=cor3)
...
def calcular():
    global todos_valores
    try:
        # O eval calcula a string
        resultado = eval(todos_valores)
        
        # Mostra o resultado na tela e atualiza a váriavel global 
        valor_texto.set(str(resultado))
        todos_valores = str(resultado)
    except: 
        # Se o usuário digitar algo errado (como '5++2, mostra erro)
        valor_texto.set("Erro")
        todos_valores = ""
        
    #limpar calculos da tela
def limpar_tela():
    global todos_valores
    todos_valores = ""
    valor_texto.set("")
...
b_16 = Button(frame_corpo, command= lambda: entrar_valores("0"), text="0", width=11, height=3, bg=cor4, fg=cor1,  font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_16.place(x=0, y=208)

b_17 = Button(frame_corpo, command= lambda: entrar_valores("."), text=".", width=5, height=3, bg=cor4, fg=cor1,  font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_17.place(x=118, y=208)

b_18 = Button(frame_corpo, text="=", width=5, height=3, bg=cor5, fg=cor1, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE, command=calcular)
